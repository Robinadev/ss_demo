...
const Profile = () => {
  const [profile, setProfile] = useState({
    firstName: 'John',
    lastName: 'Moderator',
    email: 'john.moderator@platform.internal',
    role: 'MODERATOR',
    language: 'ENG',
    timezone: 'UTC+3',
    bio: 'Experienced moderator focused on maintaining a safe community environment.',
    notifications: {
      emailReports: true,
      emailAlerts: true,
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <Badge variant="default" className="mt-1" style={{ backgroundColor: 'hsl(var(--role-moderator-primary))', color: 'white' }}>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Receive weekly moderation reports
                  </p>
                </div>
                <Switch
                  id="emailReports"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Get notified of urgent moderation issues
                  </p>
                </div>
                <Switch
                  id="emailAlerts"
